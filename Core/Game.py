...
#------------------------------- ESTÁTICOS -------------------------------------
    ...
    def elementOnWindow(cls, element):
        ...
        topLeft = Vector2(-element.width - offset, -element.height - offset)
        bottomRight = Vector2(Game.WINDOW_WIDTH + element.width + offset, Game.WINDOW_HEIGHT + element.height + offset)
